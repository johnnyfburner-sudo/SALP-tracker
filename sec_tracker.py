...
ACTION_TOPICS = [
    ...
    "include current share price so the reader knows what they are getting into",
]
# -------------------------------------------------------
